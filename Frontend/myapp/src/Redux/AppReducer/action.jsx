...
return axios.get(`${url}/user/social`,{
    headers:{
...
return axios.get(`${url}/insta/socialpost/${_id}`,{
    headers:{
      "Content-Type":"application/json",
      "Authorization":`Bearer ${token}`
    },
 ...
 return    dispatch(getsingledataSucess(res.data))
  ...
  export const GetMyPost = (dispatch) => {
   dispatch(MypostReq())
return axios.get(`${url}/insta/socialpost`,{
    headers:{
      "Content-Type":"application/json",
      "Authorization":`Bearer ${token}`
    },
...
export const  DeletePost  =(_id) => (dispatch) => {
   ...
   return axios.delete(`${url}/insta/socialdelete/${_id}`,{
    headers:{
       "Content-Type":"application/json",
       "Authorization":`Bearer ${token}`
     },
...
export const  UpdatedPost  =(_id,payload) => (dispatch) => {
   ...
   return axios.patch(`${url}/insta/socialupdate/${_id}`, payload,{
    headers:{
       "Content-Type":"application/json",
       "Authorization":`Bearer ${token}`
     },
 ...
 export const  AddPost  =(payload) => (dispatch) => {
   dispatch(AdddataReq())
   return axios.post(`${url}/insta/create`, payload,{
    headers:{
       "Content-Type":"application/json",
       "Authorization":`Bearer ${token}`
     },
